...
function vowelCount(str){
    ...
    strArray.forEach(function(letter){
        ...
        if(vowels.indexOf(lowerLetter) !== -1){
            if(Object[lowerLetter]){
                Object[lowerLetter]++;
            }else{
                Object[lowerLetter] = 1;
            }
        }});
...
function removeVowels(str) {
    ...
    return newArray.filter(function(letter){
...
function doubleOddNumbers(arr) {
    const  newArray = arr.filter(function(num){
     return   num % 2 !== 0})
     return newArray.map(function(int){
        return int * 2;    
    })
}
